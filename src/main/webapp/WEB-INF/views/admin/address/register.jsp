			...
			<div class="col-8">
				<div class="row" align="center">
					...
					<div class="col-7 mt-2" align="left">
						<input type="text" class="input" id="sample4_name"
							placeholder="이름">
					</div>
					...
					<div class="col-7 mt-2" align="left">
						...
						<div class="col-12 mt-2" align="center">
							<button class="btn btn-outline-dark btn-custom">취소</button>
							<button class="btn btn-outline-dark btn-custom">저장</button>
						</div>
					</div>
				</div>
				<div class="col-2">side</div>
