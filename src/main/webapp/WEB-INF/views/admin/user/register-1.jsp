...
<div class='container register-container' id='terms'>
  <div class='row'>
    <div class='col-12 d-flex justify-content-center'>
      <h3 class='w-75 text-center'>Register</h3>
    </div>
  </div>
  <div class='row'>
    <div class='col-12 d-flex justify-content-center'>
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
    ...
    <div class='col-12 d-flex justify-content-center'>
      <div class='form-check-reverse term-check'>
        <input type='checkbox' name='term1' id='term1' class='form-check-input term chk'>
        <label for='term1' class='form-check-label checkbox-style'>Agree</label>
      </div>
    </div>
  </div>
  <hr>
...
2) 시행일자 : 2018년 05월 01일
    ...
    <div class='col-12 d-flex justify-content-center'>
      <div class='form-check-reverse term-check'>
        <input type='checkbox' name='term2' id='term2' class='form-check-input term chk'>
        <label for='term2' class='form-check-label checkbox-style'>Agree</label>
      </div>
    </div>
  </div>
  <hr>
  <div class='row'>
    <div class='col-12 d-flex justify-content-center'>
      <div class='form-check-reverse term-check'>
        <input type='checkbox' class='form-check-input term' id='check-all'>
        <label for='check-all' class='form-check-label checkbox-style'>Agree All</label>
      </div>
    </div>
  </div>
  <hr class='blank-row'>
  <div class='row'>
    <div class='col-12 d-flex justify-content-center'>
      <div class='buttons d-flex justify-content-end'>
        <button class='btn btn-outline-secondary btn-sm-custom me-2'>
          Cancel
        </button>
        <button class='btn btn-outline-dark btn-sm-custom' id="to-next">
          Next
        </button>
      </div>
    </div>
...
<div class='container hidden register-container' id='forms'>
  <div class='row'>
    <div class='col-12 d-flex justify-content-center'>
      <h3 class='w-75 text-center'>Register</h3>
    </div>
  ...
  <div class='row'>
    <div class='col-12 d-flex justify-content-center'>
      <form action='/admin/user/register' method='post' class='account-form'>
        <input type='hidden' name='role-id' value='1'>
        <input type='hidden' name='role-name' value='일반 사용자'>
        <input type='hidden' name='account-id' value='0'>
        ...
        <div class='form-floating accordion' id='username-input'>
          ...
          <div class='accordion-item'>
            <button class='accordion-button hidden' type='button' data-bs-toggle='collapse' data-bs-target='#validateUsername'
                    aria-expanded='true' aria-controls='validateUsername' id='username-accordion-btn'>
            </button>
            <div id='validateUsername' class='accordion-collapse collapse' aria-labelledby='headingOne'
                 data-bs-parent='#username-input'>
        ...
        <div class='form-floating'>
          ...
          <div class='password-condition'>
            <p class='check-password' id='upper'>✦ 영어 대문자를 포함해야 합니다.</p>
            <p class='check-password' id='down'>✦ 영어 소문자를 포함해야 합니다.</p>
            <p class='check-password' id='number'>✦ 숫자를 포함해야 합니다.</p>
            <p class='check-password' id='special'>✦ 특수문자를 포함해야 합니다.</p>
            <p class='check-password' id='length'>✦ 길이가 8~15자 사이어야 합니다.</p>
          </div>
        </div>
        <div class='form-floating'>
        ...
        <div class='row w-75'>
          <div class='col-4 d-flex justify-content-center'>
            <div class='form-check'>
              <input type='checkbox' class='form-check-input term' name='email-marketing'
                     id='email-marketing'>
              <label for='email-marketing' class='form-check-label'>Accept email</label>
            </div>
          </div>
          <div class='col-4 d-flex justify-content-center'>
            <div class='form-check'>
              <input type='checkbox' class='form-check-input term' name='sms-marketing' id='sms-marketing'>
              <label for='sms-marketing' class='form-check-label'>Accept SMS</label>
            </div>
          </div>
          <div class='col-4 d-flex justify-content-center'>
            <div class='form-check'>
              <input type='checkbox' class='form-check-input term' name='kakao-marketing'
                     id='kakao-marketing'>
              <label for='kakao-marketing' class='form-check-label'>Accept kakaotalk</label>
            </div>
          </div>
        </div>
        <hr class='blank-row'>
        <button class='align-self-center btn btn-outline-dark btn-custom'>REGISTER</button>
      </form>
    </div>
  </div>
</div>